const SMART_DNS_I18N = {
  en: {
    ...
    deviceName:"Device name", deviceType:"Device", otherDevice:"Other", continueSetup:"Continue", installNow:"Install Smart DNS profile", manualSetup:"Manual setup", manualSetupText:"Use this personal DoH address in the encrypted DNS settings on this device.", profileReady:"Smart DNS is ready for {name}. Install the profile on this device.", manualReady:"Smart DNS access is ready for {name}. Use the personal DoH address below.", linkExpires:"The installation link is available for 24 hours.",
    create:"Create",
  ...
  lv: {
    ...
    deviceName:"Ierīces nosaukums", deviceType:"Ierīce", otherDevice:"Cita", continueSetup:"Turpināt", installNow:"Instalēt Smart DNS profilu", manualSetup:"Manuāla iestatīšana", manualSetupText:"Norādiet šo personīgo DoH adresi šīs ierīces šifrētā DNS iestatījumos.", profileReady:"Smart DNS ierīcei “{name}” ir gatavs. Instalējiet profilu šajā ierīcē.", manualReady:"Smart DNS piekļuve ierīcei “{name}” ir gatava. Izmantojiet zemāk norādīto personīgo DoH adresi.", linkExpires:"Instalēšanas saite ir derīga 24 stundas.",
    create:"Izveidot",
