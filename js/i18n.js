const SMART_DNS_I18N = {
  en: {
    ...
    routeLocal:"Main TOLF DNS", routeRussia:"Russian regional DNS", routeGlobal:"Global DNS route", noAddress:"No address", enterDomain:"Enter a domain name.", checking:"Checking…", checkFailed:"Unable to check this domain.",
  ...
  ru: {
    ...
    routeLocal:"Основной DNS TOLF", routeRussia:"Российский региональный DNS", routeGlobal:"Глобальный DNS-маршрут", noAddress:"Нет адреса", enterDomain:"Введите доменное имя.", checking:"Проверяем…", checkFailed:"Не удалось проверить домен.",
  ...
  lv: {
    ...
    routeLocal:"TOLF pamata DNS", routeRussia:"Krievijas reģionālais DNS", routeGlobal:"Globālais DNS maršruts", noAddress:"Nav adreses", enterDomain:"Ievadiet domēna nosaukumu.", checking:"Pārbaudām…", checkFailed:"Neizdevās pārbaudīt domēnu.",
