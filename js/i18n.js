const SMART_DNS_I18N = {
  en: {
    ...
    status:"Status",
    details:"Details", diagnosticLocal:"Main route", diagnosticRussia:"Regional route", diagnosticEcs:"Quad9 ECS",
  ...
  ru: {
    ...
    status:"Состояние",
    details:"Подробности", diagnosticLocal:"Основной вариант", diagnosticRussia:"Региональный вариант", diagnosticEcs:"Quad9 ECS",
  ...
  lv: {
    ...
    status:"Statuss",
    details:"Detaļas", diagnosticLocal:"Pamata variants", diagnosticRussia:"Reģionālais variants", diagnosticEcs:"Quad9 ECS",
